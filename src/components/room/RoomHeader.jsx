...
import {
    ...
    ChevronDown, Presentation, LayoutGrid, Sidebar
} from 'lucide-react';
        ...
        <div className="w-full px-2 sm:px-4 pt-3 sm:pt-4 pb-1 z-40 shrink-0 relative">
            ...
            <div className="flex items-center gap-2 overflow-hidden min-w-0">
                ...
                <div className="flex flex-col min-w-0">
                    <h1 className={`text-[11px] sm:text-sm font-semibold tracking-tight truncate max-w-[120px] xs:max-w-[160px] sm:max-w-none leading-tight ${isDark ? 'text-white/90' : 'text-gray-900'}`}>
                ...
                <div className="relative" ref={viewMenuRef}>
                    <button
                        ...
                        {viewMode === 'speaker'
                            ...
                            : viewMode === 'sidebar'
                            ? <Sidebar size={13} className="text-blue-400" />
                            : <LayoutGrid size={13} className="text-blue-400" />}
                        <span className="hidden xs:inline text-[11px] font-bold">
                            {viewMode === 'speaker' ? 'Speaker' : viewMode === 'sidebar' ? 'Sidebar' : 'Gallery'}
                        </span>
                    ...
                    {viewMenuOpen && (
                        <div className={`absolute right-0 mt-2 w-52 rounded-xl shadow-2xl py-2 z-50 animate-in fade-in zoom-in-95 duration-200 ${isDark ? 'bg-[#1e222d] border border-white/10' : 'bg-white border border-gray-200'}`}>
                            ...
                            {[
                                ...
                                { id: 'sidebar', icon: <Sidebar size={14} />, label: 'Sidebar View' },
